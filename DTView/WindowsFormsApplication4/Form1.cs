...
namespace Cortex
{
    public partial class Form1 : Form
    {
        ...
        private void popCB()
        {
            ...
            foreach (Scroll data in Main.Archives)
            {
                name = data.Name;
        ...
        {//SETS THE PRIMARY BLOCK TYPE FOR THE MAP EDITOR
            block[0] = Main.Archives.getScroll(comboBox1.SelectedIndex).Symbol;
        }
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {//SETS THE SECONDARY BLOCK TYPE FOR THE MAP EDITOR

            block[1] = Main.Archives.getScroll(comboBox2.SelectedIndex).Symbol;
        }
        ...
        private void reply(List<string> otpt)
        {
            String text = "";
            foreach (String line in otpt)
            {
                text += "\r\n" +  line;
            }
        ...
        private void textBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                reply(textBox1.Text);
                reply(Terminal.prompt(textBox1.Text));
                textBox1.Clear();
            }
        }
