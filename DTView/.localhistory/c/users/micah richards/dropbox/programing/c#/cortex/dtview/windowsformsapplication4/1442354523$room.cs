...
namespace Cortex
{
    class Room
    {
        ...
        {//GROUPS THE BLOCKS BY TYPE
            ...
            = Main.Archives.getScrollC(sym);
                if (data.Symbol.Equals(sym))
                {
                    switch (sense)
                    {
                        case 'D'://Density
                            return Main.Archives.getScrollC(sym).CharSees[0];
                        case 'T'://Density
                            return Main.Archives.getScrollC(sym).CharSees[1];
                        case 'N'://Scent
                            return Main.Archives.getScrollC(sym).CharSees[2];
                        case 'A'://Audio
                            return Main.Archives.getScrollC(sym).CharSees[3];
                    }
                }
            }
            return -1;
