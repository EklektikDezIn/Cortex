...
namespace NextGen
{
    class Archive
    {
        ...
        public Archive(String nam, String sym, String tex, String rot, String user, String car, String bene, String map)
        {
            Name = nam;
            Symbol = sym[0];
            if (tex.Contains("ALL"))
        ...
        public Archive(string name, char symbol, Texture textr, Vector3 rotaxis, float[] user, int[] car, int[] bene, char map, int prob)
        {
            Name = name;
            Symbol = symbol;
            Textr = textr;
        ...
        public Archive Clone()
        {
            ...
            return new Archive(Name, Symbol, Textr, RotAxis, temp, temp2, temp3, MapRender, Probability);
        }
