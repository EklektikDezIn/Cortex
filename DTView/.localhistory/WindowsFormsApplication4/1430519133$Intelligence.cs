    ...
    class Intelligence
    {
        ...
        public int Logos(Vector3 home, List<Vector4> Paths)
        {
            ...
            foreach (Vector4 path in Paths)
            {
                ...
                char[] contact = {Inpt.getObjectAt(path.Xyz.offSet(0,0,1)),
                                  Inpt.getObjectAt(path.Xyz.offSet(0,0,-1)),
                                  Inpt.getObjectAt(path.Xyz.offSet(0,1,0)),
                                  Inpt.getObjectAt(path.Xyz.offSet(0,-1,0)),
                                  Inpt.getObjectAt(path.Xyz.offSet(1,0,0)),
                                  Inpt.getObjectAt(path.Xyz.offSet(-1,0,0)),
                                 };
                foreach (char car in contact)
                {
                    ...
                    Value += (int)Math.Ceiling(Value / energy);
                }
            }
            if (Value > 0)
            {
