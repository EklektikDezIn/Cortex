...
namespace NextGen
{
    class Intelligence
    {
        ...
        public Vector3 Psyche()
        {
            ...
            foreach (Vector4 option in Choices)
            {
        ...
        public int Logos(char Object, Vector3 alpha, Vector4 beta, int[] Stats)
        {
            int a, b, c;
