...
namespace NextGen
{
    ...
    {//EXTENDS OPENTK.VECTOR3 OBJECT
        ...
        public static List<int> orderCoor(this Vector3 vec)
        {
            ...
            order.Add(new Vector2((int)Math.Abs(vec.X),0));
            order.Add(new Vector2((int)Math.Abs(vec.Y),1));
            order.Add(new Vector2((int)Math.Abs(vec.Z),2));
            order.Sort();
            if (order[0].X == (int)Math.Abs(vec.X))
            {
                order[0].setX(vec.X);
            }
            else if (order[0].X == (int)Math.Abs(vec.Y))
            {
                order[0].setX(vec.Y);
            }
            else if (order[0].X == (int)Math.Abs(vec.Z))
            {
                order[0].setX(vec.Z);
            }


            if (order[1].X == (int)Math.Abs(vec.X))
            {
                order[1].setX(vec.X);
            }
            else if (order[1].X == (int)Math.Abs(vec.Y))
            {
                order[1].setX(vec.Y);
            }
            else if (order[1].X == (int)Math.Abs(vec.Z))
            {
                order[1].setX(vec.Z);
            }


            if (order[2].X == (int)Math.Abs(vec.X))
            {
                order[2].setX(vec.X);
            }
            else if (order[2].X == (int)Math.Abs(vec.Y))
            {
                order[2].setX(vec.Y);
            }
            else if (order[2].X == (int)Math.Abs(vec.Z))
            {
                order[2].setX(vec.Z);
            }
