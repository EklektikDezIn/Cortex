    ...
    class Intelligence
    {
        ...
        public int Logos(Vector3 home, List<Vector4> Paths)
        {
            ...
            foreach (Vector4 path in Paths)
            {
                ...
                List<char> contact = new List<char>();
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(0, 0, 1)));
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(0, 0, -1)));
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(0, 1, 0)));
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(0, -1, 0)));
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(1, 0, 0)));
                contact.Add(Inpt.getObjectAt(path.Xyz.offSet(-1, 0, 0)));
